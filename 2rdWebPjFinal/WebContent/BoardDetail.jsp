...
<body bgcolor="#6ADEDA">
	<%
		int num = Integer.parseInt(request.getParameter("num"));  //게시판에서 보내주는 번호를 넘겨 받음
		BbsDAO dao = new BbsDAO();

		BbsDTO dto2 = dao.selectDetail(num);  //받아온 게시판의 번호를 이용해 해당번호의 게시판 정보를 불러옴
	%>
		...
		<div class="whiteboard">
			<div align="right">
				...
				<button type="button" id="update" name="update"
					class="waves-effect waves-light btn">수정!</button> <!-- 정보를 입력하고 난후의 수정 버튼 -->
				<a href="Delete.jsp?num=<%=dto2.getNum()%>" type="button"
					id="delete" name="delete" class="waves-effect waves-light btn">삭제!</a> <!-- 해당 게시판 삭제버튼 -->
			</div>
