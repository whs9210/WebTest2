...
%>
	...
	<main>
		<section class="front" style="padding-left:1.5rem; padding-right: 1.5rem;">
			<div class="box">
			...
			<div class="box">
				<a href="rstListOfDistrict.jsp?districtId=마포구"> <img class="boxpic" src="Imgs/4.png"> <span
					class="boxtext">마포구</span>  
				</a>
			</div>
			<div class="box">
				<a href="rstListOfDistrict.jsp?districtId=서대문구"> <img class="boxpic" src="Imgs/3.png"> <span
					class="boxtext">서대문구</span>
				</a>
			</div>
			<div class="box">
				<a href="rstListOfDistrict.jsp?districtId=동작구"> <img class="boxpic" src="Imgs/5.png"> <span
					class="boxtext">동작구</span>
				</a>
			</div>
			<div class="box">
